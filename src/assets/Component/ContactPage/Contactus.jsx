...
const Contactus = () => {
  ...
  const handlePhoneChange = (phone) => {
    ...
    setPhoneError(numericPhone.length < 8 ? "Phone number is invalid." : "");
  };
        ...
        <div className="row">
          <div className="col-md-6">
            <form className="row g-3 border shadow p-3 mb-5 bg-body-tertiary rounded px-5" onSubmit={handleSubmit}>
              ...
              <div className="col-12">
                <label htmlFor="phone" className="form-label text-start d-block px-3">Phone</label>
                <PhoneInput
                  country={"us"}
              ...
              <div className="col-12">
                <label htmlFor="message" className="form-label text-start d-block px-3">Message</label>
                <textarea
                  className="form-control"
                  id="message"
                  name="message"
            ...
            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 gy-4 py-4 px-5">
              ...
              <div className="col py-4">
                ...
                <ul className="list-unstyled mt-3" style={{ lineHeight: '1.8' }}>
                  ...
                  <li className="quick-link py-1">+91 98765 43210</li>
                  <li className="quick-link py-1">123 Royal Street, Mumbai</li>
                </ul>
                <div className="d-flex ms-5 mx-5 px-3">
                  <a href="https://facebook.com" className="fs-3 me-3 text-primary" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faFacebookSquare} />
                  </a>
                  <a href="https://instagram.com" className="fs-3 me-3 text-danger" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} />
                  </a>
                  <a href="https://youtube.com" className="fs-3 me-3 text-white" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faYoutube} />
                  </a>
                  <a href="https://twitter.com" className="fs-3 text-info" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
