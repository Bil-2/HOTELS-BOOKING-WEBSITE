    ...
    <div>
      ...
      <div className="Most mt-5 py-5 pt-5 opacity-100">
        <div className="latte row">
          <div className="col">
            <div className="card">
              <img src={pool} className="card-img-top" alt="Card 1" />
              <div className="card-body">
                <h5 className="card-title">Swimming Pool <br /><span className="tr text-danger">Standard Hotel</span></h5>
          ...
          <div className="col">
            <div className="card">
              <img src={smm} className="card-img-top" alt="Card 2" />
              <div className="card-body">
                <h5 className="card-title">The Dinner Place <br /><span className="text-danger">Standard Hotel</span></h5>
                <p className="card-text text-start">
          ...
          <div className="col">
            <div className="card">
              <img src={south} className="card-img-top" alt="Card 3" />
              <div className="card-body">
                <h5 className="card-title">Hotel Passage <br /><span className="text-danger">Standard Hotel</span></h5>
                <p className="card-text text-start">
      ...
      <footer className="footer mt-5" id="contact" style={{ minHeight: '300px' }}>
        ...
        <div className="text-center py-2 bg-dark text-light">
          Copyright 2024 Bil-2. All rights reserved.
        </div>
      </footer>
    </div>
  );
