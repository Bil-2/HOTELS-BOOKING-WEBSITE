...
const SmartRecommendationsWrapper = React.lazy(() => import('./components/SmartRecommendations/SmartRecommendationsWrapper'));
        ...
        <div>
          <Suspense fallback={<LoadingSpinner />}>
            <Routes>
              ...
              {/* AI-Powered Features */}
              <Route path="/recommendations" element={<SmartRecommendationsWrapper />} />
